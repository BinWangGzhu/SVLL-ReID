...
class ModifiedResNet(nn.Module):
    ...
    def forward(self, x,is_aug=None):
        def stem(x):
        ...
        # If the input x is either aug1 or aug2, return aug_embedding directly.
        if is_aug == True:
            return x4
...
class VisionTransformer(nn.Module):
    ...
    def forward(self, x: torch.Tensor, cv_emb = None,is_aug = None):
        ...
        # If the input x is either aug1 or aug2, return the normalized aug_embed directly.
        if is_aug == True:
            return x12
...
class CLIP(nn.Module):
    def __init__(self,
        ...
        if isinstance(vision_layers, (tuple, list)):
            ...
            vision_heads = vision_width // 64 #vision_heads =12
    ...
    def forward(self, image, text):
        ...
        logits_per_image = logit_scale * image_features @ text_features.t()  # Cosine similarity between each image and all text.
