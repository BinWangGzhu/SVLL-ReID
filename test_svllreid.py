...
import argparse
from datasets.make_dataloader_svllreid import make_dataloader
from model.make_model_svllreid import make_model
from processor.processor_svllreid_stage2 import do_inference
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--config_file", default="configs/person/vit_svllreid.yml", help="path to config file", type=str
    )
